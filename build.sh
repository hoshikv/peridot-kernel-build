...
FB_SCHED_FEAT="CONFIG_OPLUS_FEATURE_SCHED_ASSIST CONFIG_OPLUS_FEATURE_SCHED_DDL CONFIG_OPLUS_SCHED_GROUP_OPT CONFIG_OPLUS_CPU_AUDIO_PERF CONFIG_OPLUS_FEATURE_LOADBALANCE CONFIG_OPLUS_FEATURE_PIPELINE CONFIG_BLOCKIO_UX_OPT"
